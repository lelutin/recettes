...
* 2 grosses poitrines de poulet désossées, faire des incisions en quadrillé sur
  l'extérieur des poitrines
...
* environs 60g fromage parmesan, râpé
  * assez pour saupoudrer les pâtes et la sauce et un peu plus pour décorer les
    plats.
...
2. Saler un peu les poitrines de poulet et masser le sel dans le poulet
3. Chauffer une poêle à 150°C (300°F). Ajouter un fond d'huile d'olive et
   (facultatif) beurre. Ajouter le poulet à la poêle.
4. Retourner les poitrines après 2 minutes. Laisser cuire un autre deux minutes
   et tourner à nouveau
...
13. Quand les 10 minutes du poulet sont écoulées, sortir le poulet du four en
    ...
    l'enduire. Ajouter les oignons verts puis baisser le feu en veilleuse
    (simmer).
14. Après la cuisson des pâtes, retirer le bouquet garni et égoutter les pâtes.
    Transférer les pâtes dans un bol ou une poêle (pour pouvoir faire des
    tourne-et-retourne). Ajouter quelques cuillers de sauce dans les pâtes, des
    oignons verts et du parmesan et mélanger le tout pour enduire les nouilles
    de sauce.
15. Servir les pâtes dans une assiette, environs un peu moins que la moitié de
    l'assiette. Ajouter une poitrine de poulet et de la sauce sur le dessus de
    la poitrine.

## Références

* <https://www.youtube.com/watch?v=2Bvq4iDvM0A>
